...
// the time a decoder sees them. responseMimeType is carried alongside the
// exchange's original fields specifically so SSE detection (sse.ts) doesn't
// have to re-derive it from response headers a second time.
